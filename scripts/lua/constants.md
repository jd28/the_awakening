...
#### CUSTOM_EFFECT_TYPE_*
* CUSTOM_EFFECT_TYPE_ADDITIONAL_ATTACKS = 0
* CUSTOM_EFFECT_TYPE_CRIT_DMG_BONUS = 21
* CUSTOM_EFFECT_TYPE_CRIT_DMG_PENALTY = 22
* CUSTOM_EFFECT_TYPE_CRIT_THREAT_BONUS = 19
* CUSTOM_EFFECT_TYPE_CRIT_THREAT_PENALTY = 20
* CUSTOM_EFFECT_TYPE_DAMAGE_IMMUNITY_ALL = 7
* CUSTOM_EFFECT_TYPE_DAMAGE_VULNERABILITY_ALL = 8
* CUSTOM_EFFECT_TYPE_DMG_PERCENT_BONUS = 23
* CUSTOM_EFFECT_TYPE_DMG_PERCENT_PENALTY = 24
* CUSTOM_EFFECT_TYPE_GOLD_BONUS = 17
* CUSTOM_EFFECT_TYPE_GOLD_PENALTY = 18
* CUSTOM_EFFECT_TYPE_HITPOINTS = 2
* CUSTOM_EFFECT_TYPE_IMMUNITY_DECREASE = 1
* CUSTOM_EFFECT_TYPE_MOVEMENT_BONUS = 15
* CUSTOM_EFFECT_TYPE_MOVEMENT_PENALTY = 16
* CUSTOM_EFFECT_TYPE_MOVEMENT_RATE = 3
* CUSTOM_EFFECT_TYPE_RECURRING = 6
* CUSTOM_EFFECT_TYPE_SPELL_DAMAGE_BONUS = 13
* CUSTOM_EFFECT_TYPE_SPELL_DAMAGE_PENALTY = 14
* CUSTOM_EFFECT_TYPE_SPELL_DC_DECREASE = 5
* CUSTOM_EFFECT_TYPE_SPELL_DC_INCREASE = 4
* CUSTOM_EFFECT_TYPE_STACKING_DMG_REDUCTION = 9
* CUSTOM_EFFECT_TYPE_STACKING_DMG_RESISTANCE = 10
* CUSTOM_EFFECT_TYPE_XP_BONUS = 11
* CUSTOM_EFFECT_TYPE_XP_PENALTY = 12
