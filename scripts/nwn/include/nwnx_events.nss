...
int GetConversationConditionalInfo()
{
    SetLocalString(OBJECT_SELF, "NWNX!FUNCS!GETCONVERSATIONCONDINFO", "                  ");

    //string sMsg = GetLocalString(OBJECT_SELF, "NWNX!FUNCS!GETCONVERSATIONCONDINFO");
...
int GetCurrentNodeType()
{
    //GetConversationConditionalInfo();
