...
*/
	...
	SetLocalInt(oTarget, "GW_PolyWeapon", nWeaponType);
	...
	SendMessageToPC(oTarget,"oWeaponOld is valid: " + IntToString(GetIsObjectValid(oWeaponOld)));
	SendMessageToPC(oTarget,"oWeaponNew is valid: " + IntToString(GetIsObjectValid(oWeaponNew)));
	SendMessageToPC(oTarget,"oArmorNew is valid: " + IntToString(GetIsObjectValid(oArmorNew)));
	SendMessageToPC(oTarget,"oClawLeft is valid: " + IntToString(GetIsObjectValid(oClawLeft)));
	SendMessageToPC(oTarget,"oClawRight is valid: " + IntToString(GetIsObjectValid(oClawRight)));
	SendMessageToPC(oTarget,"oBite is valid: " + IntToString(GetIsObjectValid(oBite)));
    //--------------------------------------------------------------------------
    // ...Weapons
    //--------------------------------------------------------------------------
    if (bWeapon) {
	...
	if ( GetIsObjectValid(oWeaponOld) ) {
		WildshapeCopyWeaponProperties(oTarget, oWeaponOld, oClawLeft);
		WildshapeCopyWeaponProperties(oTarget, oWeaponOld, oClawRight);
		WildshapeCopyWeaponProperties(oTarget, oWeaponOld, oBite);
	}
	else {
		WildshapeCopyWeaponProperties(oTarget, oBracerOld, oClawLeft);
		WildshapeCopyWeaponProperties(oTarget, oBracerOld, oClawRight);
		WildshapeCopyWeaponProperties(oTarget, oBracerOld, oBite);
