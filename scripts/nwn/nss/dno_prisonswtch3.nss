...
object oStatue3 = GetObjectByTag("dno_Inv_Statue_3");
...
DelayCommand(3.0, ApplyEffectToObject(DURATION_TYPE_INSTANT, eFlame, oStatue3));
    DelayCommand(3.5, SoundObjectPlay(oSound));
DelayCommand(3.5, ApplyEffectToObject(DURATION_TYPE_INSTANT, eFlame, oStatue3));
    DelayCommand(4.0, SoundObjectPlay(oSound));
DelayCommand(4.0, ApplyEffectToObject(DURATION_TYPE_INSTANT, eFlame, oStatue3));
    DelayCommand(4.5, SoundObjectPlay(oSound));
DelayCommand(4.5, ApplyEffectToObject(DURATION_TYPE_INSTANT, eFlame, oStatue3));

string sFlame = "dno_kersa_flame";
location lFlame = lStatue3;
