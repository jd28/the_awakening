...
int SetAge(object oCreature, int nValue);
...
int SetRemainingFeatUses (object oCreature, int nFeat, int nUses);
...
int SetClassLevel (object oCreature, int nClass, int nLevel);
int LegendaryLevel (object oCreature, int nClass, int nLevel);
...
int SetAge (object oCreature, int nValue) {
    return NWNXFuncsOne(oCreature, "NWNX!FUNCS!SETAGE", nValue);
}
...
int SetRemainingFeatUses (object oCreature, int nFeat, int nUses) {
    return NWNXFuncsTwo(oCreature, "NWNX!FUNCS!SETREMAININGFEATUSES", nFeat, nUses);
}
...
int GetPCBodyBagID (object oPC) {
    return NWNXFuncsZero(oPC, "NWNX!FUNCS!GETPCBODYBAGID");
}

int SetPCBodyBagID (object oPC, int nBodyBag) {
    return NWNXFuncsOne(oPC, "NWNX!FUNCS!SETPCBODYBAGID", nBodyBag);
}
...
int SetClassLevel (object oCreature, int nClass, int nLevel) {
    return NWNXFuncsTwo(oCreature, "NWNX!FUNCS!SETCLASSLEVEL",
                        nClass, nLevel);
}

int LegendaryLevel (object oCreature, int nClass, int nLevel) {
    return NWNXFuncsTwo(oCreature, "NWNX!FUNCS!LEGENDARYLEVEL",
                        nClass, nLevel);
}
...
int SetBaseItemType(object oItem, int nBaseType) {
    return NWNXFuncsOne(oItem, "NWNX!FUNCS!SETBASEITEMTYPE", nBaseType);
}
